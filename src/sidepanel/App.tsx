...
const App = () => {
    ...
    return (
        <main className="app-shell">
            <Toolbar leftTabId={state.leftTabId} rightTabId={state.rightTabId} selector={state.selector} loading={state.loading} tabs={state.tabs} onInspect={state.inspect} onRefresh={state.refreshTabs} onLeftTabChange={state.setLeftTabId} onRightTabChange={state.setRightTabId} onSelectorChange={state.setSelector} onOpenInTab={openInTab} />
