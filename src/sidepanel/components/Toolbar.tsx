...
export const Toolbar = ({ leftTabId, rightTabId, selector, loading, tabs, onInspect, onRefresh, onLeftTabChange, onRightTabChange, onSelectorChange, onOpenInTab }: ToolbarProps) => (
    <section className="toolbar">
        ...
        <button className="btn subtle" type="button" onClick={onOpenInTab}>Open in tab</button>
